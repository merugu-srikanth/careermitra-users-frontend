...
export default function CareerGuide() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden" style={{ background: "#ffffff", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      <SEO
        title="Career Guide | Career Mitra"
        description="Explore all major government career paths — UPSC, SSC, Banking, Railways, Defence, PSUs, and more. Find the right career for you."
        keywords="career guide, UPSC, SSC, banking jobs, railway jobs, PSU, government careers, India"
        url="https://www.careermitra.in/career-guide"
      />

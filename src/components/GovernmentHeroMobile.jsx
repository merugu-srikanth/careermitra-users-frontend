...
const GlobalStyles = () => (
  <style>{`
    ...
    @media (min-width: 769px) and (max-width: 1100px) {
      ...
      .hero-sub {
        font-size: clamp(0.92rem, 1.75vw, 1.05rem) !important;
      ...
      .hero-illustration-card {
        width: clamp(330px, 43vw, 500px) !important;
      }
    }
    @media (min-width: 1101px) {
      ...
      .hero-title {
        font-size: clamp(2.3rem, 3.8vw, 3.05rem) !important;
      }
      .hero-sub {
      ...
      .hero-illustration-card {
        width: clamp(420px, 43vw, 620px) !important;
      }
    }
    @media (max-width: 768px) {
      .hero-layout { flex-direction: column !important; align-items: center !important; padding: 0 !important; width: 100% !important; box-sizing: border-box !important; gap: 24px !important; }
      .right-panel { display: none !important; }
      .hub-svg { max-width: 430px !important; width: 100% !important; }
      .hero-content-wrap { display: flex !important; align-items: center !important; justify-content: center !important; min-height: 100vh !important; padding: 72px 20px 28px !important; box-sizing: border-box !important; width: 100% !important; }
      .hero-left { text-align: center !important; max-width: 100% !important; width: 100% !important; display: flex !important; flex-direction: column !important; align-items: center !important; gap: 14px !important; }
      .hero-cta { justify-content: center !important; flex-direction: column !important; width: 100% !important; gap: 14px !important; }
      .hero-cta button { width: 100% !important; justify-content: center !important; min-height: 60px !important; font-size: 17px !important; padding: 18px 20px !important; box-sizing: border-box !important; }
      .hero-sub { max-width: 92% !important; margin: 0 auto !important; }
    }
  `}</style>
);
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", zIndex: 0 }}>
      ...
      <div style={{
        ...
        background: "linear-gradient(90deg, transparent, rgba(249,115,22,0.08), rgba(34,197,94,0.1), transparent)",
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(34,197,94,0.16) 0%, rgba(249,115,22,0.09) 40%, transparent 72%)",
        filter: "blur(24px)",
        zIndex: 1,
      }} />
    </div>
    ...
    <div className="right-panel" style={{ position: "relative", flexShrink: 0 }}>
      ...
      >
        ...
        <div style={{ position: "relative", padding: "14px 14px 10px" }}>
          <img src={image} alt="Government Jobs" style={{ width: "100%", borderRadius: 16, marginBottom: 12, filter: "drop-shadow(0 12px 24px rgba(34,197,94,0.2)) drop-shadow(0 6px 12px rgba(249,115,22,0.15))", display: "block" }} />  
        ...
        <div
          ...
          <div className="hero-layout" style={{
            ...
            <motion.div
              ...
              style={{ flex: 1, maxWidth: 640, minWidth: 0 }}
            >
              {/* <LiveBadge /> */}
              ...
              <motion.p
                ...
                style={{
                  fontSize: "clamp(0.94rem, 1.5vw, 1.18rem)",
              ...
              >
                Start with the right direction, then choose the right opportunity.
                {" "}
              ...
              <motion.div
                ...
                style={{ marginTop: 6, marginBottom: 14, width: "100%", display: "flex", justifyContent: "center" }}
              >
              ...
              <motion.div
                ...
                style={{ display: "flex", flexDirection: "column", gap: 14, width: "100%", marginTop: 6 }}
              >
                <button
                ...
                >
                  <span style={{ width: 34, height: 34, borderRadius: "50%", background: "rgba(255,255,255,0.18)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>{Icons.bell}</span>
                  Get Free Job Alerts
                  <span style={{ width: 34, height: 34, borderRadius: "50%", background: "rgba(255,255,255,0.18)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                ...
                >
                  <span style={{ width: 34, height: 34, borderRadius: "50%", background: "rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>{Icons.grid}</span>
                  User Dashboard
                  <span style={{ width: 34, height: 34, borderRadius: "50%", background: "rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                  </span>
                </button>
              </motion.div>

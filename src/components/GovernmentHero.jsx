...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0c0500] ">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-25 pb-20 text-center">
        ...
        >
          <h1 className="font-serif text-[clamp(2.5rem,6vw,5rem)] font-black text-white leading-tight mb-2 drop-shadow-lg">
          ...
          >
            <h1 className="font-serif text-[clamp(2.8rem,5vw,5.5rem)] font-black leading-none mb-0 bg-gradient-to-r from-white via-amber-200 to-amber-500 bg-clip-text text-transparent">

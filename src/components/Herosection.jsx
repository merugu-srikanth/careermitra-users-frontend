...
const trust = ["🏛️ Official Sources", "🔔 Instant Alerts", "📱 Mobile Friendly", "🆓 Always Free"];
...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0c0500] ">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-25 text-center">
        ...
        >
          <h1 className="font-serif text-[clamp(2.5rem,7vw,5rem)] font-black text-white leading-tight mb-2 drop-shadow-lg">
            Get Personalized
          </h1>
        ...
        <motion.p 
          ...
          className="text-amber-50/70 text-[clamp(1rem,2.5vw,1.25rem)] max-w-2xl mx-auto my-6 font-medium leading-relaxed"
        >
          Find the latest government job alerts and results — 
          <span className="text-amber-400 font-bold mx-1">Central & State Jobs</span>
        ...
        >
          {trust.map((b, i) => (
            <span key={i} className="text-amber-200/40 text-sm font-semibold tracking-widest uppercase">
              {b}
            </span>
          ))}
        </motion.div>
